...
#endif
   "W25Q64_WEACTBLACK", 	 	 		// Device Name + version number
   SPI_FLASH,                  					// Device Type  (that's from Dev_Inf.h)
   0x90000000,                					// Device Start Address bylo 0x90000000
...
// Specify Size and Address of Sectors (view example below)
   EXT_FLASH_SECTOR_NUM, EXT_FLASH_SECTOR_SIZE,	// (that's from Flash interface package)
